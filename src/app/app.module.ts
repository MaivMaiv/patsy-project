...
@NgModule({
  declarations: [AppComponent, AddInventoryComponent, AddMemberComponent, AddEmployeeComponent, EditAdminComponent, EditCartAmountComponent, EditInventoryComponent, ProductSettingsComponent, ReportBestComponent, ReportVisitsComponent],
